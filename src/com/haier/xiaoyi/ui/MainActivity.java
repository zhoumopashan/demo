...
public class MainActivity extends Activity implements View.OnClickListener, WifiP2pActivityListener {
	...
	public void onPeersAvailable(WifiP2pDeviceList peers) {
		...
		if (peers.getDeviceList().size() == 1) {
			...
			if(isConnect == true && localDevice.deviceAddress.equals(device.deviceAddress)){
				return;
			}
